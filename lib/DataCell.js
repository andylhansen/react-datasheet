...
var DataCell = function (_PureComponent) {
  ...
  function DataCell(props) {
    ...
    _this.handleClickDrag = _this.handleClickDrag.bind(_this);
  ...
  _createClass(DataCell, [{
    ...
    key: 'handleClickDrag',
    value: function handleClickDrag(e) {
      e.stopPropagation();
      var _props2 = this.props,
          row = _props2.row,
          col = _props2.col,
          onClickDrag = _props2.onClickDrag,
          cell = _props2.cell;
    ...
    value: function render() {
      var _props8 = this.props,
          ...
          canClickDrag = _props8.canClickDrag,
          isCopyTarget = _props8.isCopyTarget;
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', isCopyTarget && 'copy-target', editing && 'editing', cell.readOnly && 'read-only', updated && 'updated'].filter(function (a) {
        return a;
      }).join(' ');
